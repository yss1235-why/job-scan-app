            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  This determines which tab the job appears under
                </p>
              </div>
            ...
            {formData.locationType === 'local' && (
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {MANIPUR_DISTRICTS.map(district => (
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Users will only see this job if they're from this district
                </p>
              </div>
            )}
